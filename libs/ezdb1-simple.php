<?php
	...
	class db {
		...
		function connect($master = false) {
			...
			if ( ! $this->dbh ) {
				echo _('Error conectando a la BBDD, la mafia nos castigar&aacute;, pero ya volvemos en unos segundos... si no es que Jon la ha liado, que es lo m&aacute;s probable: <strong>'). "\n";
				echo mysql_error();
				echo _('</strong>');
				die;
			}
